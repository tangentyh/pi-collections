...
| [pi-footer-template](extensions/footer-template) | Render pi's footer from a configurable string template; per-run throughput notification is also templatable |
